import { Link, NavLink } from "react-router"; // Note: standard is react-router-dom

const Navbar = () => {
    // Shared class logic for NavLinks to keep code clean
    const navLinkClasses = ({ isActive }) =>
        `relative pb-1 transition-all duration-300 hover:text-yellow-500 hover:scale-105 ${
